...
class DireccionsControllerTest < ActionController::TestCase
  ...
  test "should create direccion" do
    assert_difference('Direccion.count') do
      post :create, direccion: { calle: @direccion.calle, casa: @direccion.casa, ciudad: @direccion.ciudad, zona: @direccion.zona }
    end
  ...
  test "should update direccion" do
    patch :update, id: @direccion, direccion: { calle: @direccion.calle, casa: @direccion.casa, ciudad: @direccion.ciudad, zona: @direccion.zona }
    assert_redirected_to direccion_path(assigns(:direccion))
  end
